  ...
  return {
    ...
    daily_report: {
      ...
      cells_to_clear_by_name_contains: {
        // セッション欄をE9〜E16(8セッション分)に拡張したテンプレートに合わせた設定。
        // 内容・学んだこと・今後の活用・活用実践の成果は、拡張した2行分だけ下にシフトしている(D15→D17, B21→B23, B28→B30, B34→B36)。
        'Udemy受講レポート': [[9, 5], [10, 5], [11, 5], [12, 5], [13, 5], [14, 5], [15, 5], [16, 5], [13, 4], [14, 4], [17, 4], [23, 2], [30, 2], [36, 2], [9, 19], [10, 19], [11, 19], [12, 19], [13, 19], [14, 19], [15, 19], [16, 19], [9, 24]],
